...
\end{itemize}
Architektúrou bude \textbf{SPA (Single Page Application)} a navyše v priebehu implementácie bude testovaná na posledných verziách: \textit{Chrome, Firefox, Safari a Edge}.
